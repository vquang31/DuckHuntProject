...
//        tableLabel[1].setBounds( , ,tableImageIcon[1].getIconWidth(), tableImageIcon[1].getIconHeight());
        ...
        startButtonImage.setBounds(width / 2  - startButtonIcon.getIconWidth() / 2 ,
                                   height /3 - 200,
                                   startButtonIcon.getIconWidth(), startButtonIcon.getIconHeight());
        ...
        exitButtonImage.setBounds(width / 2  - exitButtonIcon.getIconWidth() / 2 ,
                                   height /3  ,
                                   exitButtonIcon.getIconWidth(), exitButtonIcon.getIconHeight());
